...
namespace popsDiner.Models
{
    public class ItemRepository : IItemRepository
    {
        ...
        {
            return _appDbContext.Items.FirstOrDefault(i => i.Name.Equals(ItemName));
        }

        public Item GetItemByPrice(int ItemPrice)
        {
            return _appDbContext.Items.FirstOrDefault(i => i.Price == ItemPrice);
        }
